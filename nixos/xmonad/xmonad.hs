...
-- ## Startup hook ## ---------------------------------------------------------------
myStartupHook = do
    spawnOnce "bash ~/.xmonad/autorun.sh"
...
myManageHook = composeAll . concat $
    ...
    where
        ...
        myTFloats = ["Downloads", "Save As...", "About : Aditya Shakya", "Getting Started", "Application Finder"]
        myRFloats = []
...
defaults = def {
      ...
      -- hooks, layouts
        ...
        layoutHook         = gaps [(L,35), (R,0), (U,30), (D,0)] $ spacingRaw False (Border 10 0 10 0) True (Border 0 10 0 10) True $ myLayout,
